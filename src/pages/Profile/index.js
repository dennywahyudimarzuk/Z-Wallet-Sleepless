...
class Profile extends Component {
    ...
    uploadHandler = () => {
        ...
        axios.put(`${process.env.REACT_APP_API}/profile/image`, formData)
        .then(res => {
                                   ...
                                   <NavigationMobile  to="/dashboard"/>
                                    ...
                                    <div className="row ">
                                        <div className="col-12 text-center ">
                                                ...
                                                <img alt="" src={process.env.REACT_APP_URL+this.props.userData.photo} className="img-fluid profile-image" />
